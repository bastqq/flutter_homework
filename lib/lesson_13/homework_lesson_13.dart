  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final width =
            redContainerWidth >= constraints.maxWidth
...
//... розміри задані через SizedBox З вищим пріорітетом
...
/// Відповідь: ... owerflowbox дозволяе виходити за межі контейнерів тільки
///  вище по списку
...
// Відповідь: ... висота другого Column задана через sizedbox
...
// Відповідь: ... Limitetbox не впливає на розмір в звичайних віджетах,а тільки
// в віджетах типу listview, column, row..
