...
import 'package:flutter_homework/error_handling_homework/presentation/cubit/user_profile_state.dart';
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        state.error.status,
                        style: TextStyle(
                          color: const Color.fromARGB(255, 210, 4, 4),
                          fontSize: 24,
                        ),
                      ),
                      ElevatedButton(
                        ...
                        child: Text(
                          'Спробувати знову',
                          style: TextStyle(
                            color: const Color.fromARGB(255, 10, 1, 7),
                            fontSize: 24,
                          ),
                        ),
                      ),
